...
class Send:
    def email(self, message):
        ...
        msg['Subject'] = 'Catawba Sales'
        msg['From'] = "Dalcom Sales Monitor"
        msg['To'] = "jwright@dalcom.com"
...
while True:
    ...
    check.grab("C:\\INV\\IN\\11\\STORE011.TXT")
    check.grab("C:\\INV\\IN\\12\\STORE012.TXT")


    print("Polling Folders Checked")
    time.sleep(5)
    if current_time == "22:45" or len(polled_sales) == 12:
        send = Send()
        polled_sales_data = ("\n".join(polled_sales))
        ...
        Results Returned: {number_of_sales}                 Expected: 12
